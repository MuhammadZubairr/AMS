    ...
    <main className="min-h-screen px-4 py-8 sm:py-12">
      <section className="mx-auto w-full max-w-md rounded-[1.75rem] border border-blue-100 bg-white/95 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur sm:p-8">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-2xl font-bold text-slate-900 sm:text-3xl">Create account</h1>
          <p className="mt-3 text-sm leading-6 text-slate-600">Register to start marking attendance from desktop or mobile.</p>
        </div>
        ...
        <p className="mt-6 text-sm text-slate-600">
          Already registered? <a className="font-semibold text-blue-600" href="/login">Login</a>
        </p>
      </section>
    </main>
  );
