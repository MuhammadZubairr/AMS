export default function Sidebar() {
  ...
  return (
    <aside className="w-full rounded-3xl border border-blue-100 bg-white p-4 shadow-[0_12px_30px_rgba(15,23,42,0.05)] lg:w-72 lg:shrink-0 lg:p-5">
      <div className="flex items-center justify-between gap-3 lg:block">
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-blue-600">Menu</p>
